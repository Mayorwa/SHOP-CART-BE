...
trait ProvidesApiResponses
{
     ...
     * @return JsonResponse
     */
    public function okResponse(string $message, mixed $data = null): JsonResponse
    {
    ...
    /**
     * Send a formatted 403 HTTP response.
     *
     * @param string|null $message
     * @param null $data
     * @return JsonResponse
     */
    public function forbiddenResponse(string $message = null, $data = null): JsonResponse
    {
        return response()->json([
            'status' => false,
            'message' => $message,
